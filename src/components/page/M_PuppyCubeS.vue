<template>
  <div id="PuppyCubeS">
    <div class="video_container">
      <div class="box">
        <img id="bgvideo" width="100%" src="./../../assets/video/cube-s-mobile.jpg">
    ...
    <div class="div_order_mobile" v-show="orderCubeS" @touchmove.prevent>
    ...
    <div class="designImg" style="background-color:#FFFFFF;">
      ...
      <img src="./../../assets/images/m_puppy_cube_s/div_aick.jpg"  style="max-width:1440px;">
    </div>
    <div class="imageFooter">
    ...
    <div class="designImg" style="background-color:#ff5a32;">
      ...
      <img src="./../../assets/images/m_puppy_cube_s/div_aiyy.jpg"  style="max-width:1440px;">
    </div>
    <div class="designImg" style="background-color:#101010;">
        <!-- <div class="img_cdj imgBackCenter"> </div> -->
        <img src="./../../assets/images/m_puppy_cube_s/div_cdj.jpg"  style="max-width:1440px;">
    </div>
    <div class="designImg" style="background-color:#FFFFFF;">
        <!-- <div class="img_cpts imgBackCenter"> </div> -->
        <img src="./../../assets/images/m_puppy_cube_s/div_cpts.jpg"  style="max-width:1440px;">
    </div>
    <div class="designImg" style="background-color:#000000;">
        <!-- <div class="img_cpcs_01 imgBackCenter"> </div> -->
        <img src="./../../assets/images/puppy_cube_s/div_cpcs_01.jpg" style="max-width:636px;">
    </div>
    <div class="designImg" style="background-color:#000000;">
        <!-- <div class="img_cpcs_02 imgBackCenter"> </div> -->
        <img src="./../../assets/images/puppy_cube_s/div_cpcs_02.jpg" style="max-width:636px;">
    </div>
    ...
    <!-- <div class="productPara">
        ...
        <div class="paraDetail">
            ...
            <div class="detailContent">puppy cube s</div>
            ...
            <div class="detailTitle">产品材质</div>
            <div class="detailContent">高透光覆膜玻璃面板</div>
        </div>
...
export default {
    data() {
        return {
            ...
            {            
             ...
             {            
                id: 2,
                img: require("./../../assets/images/m_puppy_cube_s/div_sj_02.jpg"),
                maxWidth: '1440px',
                backgroundColor: "#ffffff",
                video: require("./../../assets/video/puppy_cube_s/light_breath_mobile.mp4"),
                title: '设计',
                slogan: '友好交互设计 — 智慧呼吸灯',
    ...
    mounted() {
        document.querySelector(".divMp4Front").style.height = ((window.document.body.offsetWidth<1440?window.document.body.offsetWidth:1440) * (800 /1440)).toFixed(2) + "px";
        document.querySelector(".divMp4Words").style.height = ((window.document.body.offsetWidth<1440?window.document.body.offsetWidth:1440) * (800 /1440)).toFixed(2) + "px";
